...
This application is **not a medical diagnostic tool**, but rather an assistive device. Predictions are generated by an AI model and should not be used as a substitute for professional medical advice.
