...
async function useSampleImage() {
    ...
    canvas.toBlob(async (blob) => {
        const file = new File([blob], 'sample_mri.png', { type: 'image/png' });
        
        // Preview
        document.getElementById('imagePreview').src = canvas.toDataURL();
        document.getElementById('imageInfo').textContent = 'Sample MRI Image';
        document.getElementById('imageSize').textContent = 'Sample Data';
